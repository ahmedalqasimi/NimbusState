...
#[derive(Debug)]
pub struct NimbusStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NimbusStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NimbusState processing");
    
    let mut processor = NimbusStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NimbusStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NimbusStateProcessor::new(false);
